      ...
      <ScrollView style={styles.container}>
        <View style={styles.gridContainer}>
          ...
          <View style={styles.rowContainer}>
            ...
            listBackgroundColors[1]}, styles.item]}
            onPress={() => {
              this.playSound("one")
            }}
            >
            ...
            style={[ {backgroundColor: 
            listBackgroundColors[2]}, styles.item]}
            onPress={() => {
              this.playSound("two")
            }}
            >
          ...
          <View style={styles.rowContainer}>
            ...
            style={[ {backgroundColor: 
            listBackgroundColors[3]}, styles.item]}
            onPress={() => {
            ...
            style={[ {backgroundColor: 
            listBackgroundColors[4]}, styles.item]}
            onPress={() => {
              this.playSound("four")
            }}
            >
          ...
          <View style={styles.rowContainer}>
            ...
            style={[ {backgroundColor: 
            listBackgroundColors[5]}, styles.item]}
            onPress={() => {
              this.playSound("five")
            }}
            >
            ...
            style={[ {backgroundColor: 
            listBackgroundColors[6]}, styles.item]}
            onPress={() => {
              this.playSound("six")
            }}
            >
          ...
          <View style={styles.rowContainer}>
            ...
            style={[ {backgroundColor: 
            listBackgroundColors[7]}, styles.item]}
            onPress={() => {
            ...
            style={[ {backgroundColor: 
            listBackgroundColors[8]}, styles.item]}
            onPress={() => {
          ...
          <View style={styles.rowContainer}>
            ...
            style={[ {backgroundColor: 
            listBackgroundColors[9]}, styles.item]}
            onPress={() => {
              this.playSound("nine")
            }}
            >
            ...
            style={[ {backgroundColor: 
            listBackgroundColors[10]}, styles.item]}
            onPress={() => {
              this.playSound("ten")
            }}
            >
